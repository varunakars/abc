...
namespace MVCDHProject.Controllers
{
    ...
    public class ErrorController : Controller
    {
        ...
        public IActionResult ClientErrorHandler(int StatusCode)
        {
            switch (StatusCode)
            {
                case 400:
                    ...
                    break;
                case 401:
                    ViewBag.ErrorTitle = "Unauthorized or Authorization Require";
                ...
                case 403:
                    ...
                    ViewBag.ErrorMessage = "You are attempting toto access the resource that you don’t have permission to view.";
                    break;
                case 404:
        ...
        [Route("ServerError")]
        public IActionResult ServerExceptionHandler()
        {
